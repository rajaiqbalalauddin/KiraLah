...
data class ReceiptItem(val name: String, val qty: Int, val priceSen: Long)
...
data class ParsedReceipt(
    ...
    /** Service + tax + rounding - discount. Can be negative when a discount is bigger than the charges. */
    val extrasSen: Long get() = serviceSen + taxSen + roundingSen - discountSen
}
...
object ReceiptParser {
    ...
    fun parse(rows: List<String>): ParsedReceipt {
        ...
        return ParsedReceipt(items, service, tax, rounding, discount, total)
    }
